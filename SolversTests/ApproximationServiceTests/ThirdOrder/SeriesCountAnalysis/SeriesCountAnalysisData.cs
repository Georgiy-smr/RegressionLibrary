...
/// <summary>
/// Sensor 235 calibration data (0-200 kPa range), shared across the SeriesCountAnalysis test
/// classes so the three datasets are transcribed exactly once each.
/// </summary>
public static class SeriesCountAnalysisData
{
    /// <summary>3 real temperature series (33 points), all measured.</summary>
    public static readonly List<DataTwoFact> ThreeOriginal = new()
    {
    ...
    /// <summary>5 real temperature series (55 points), a superset of ThreeOriginal plus 2 more real series.</summary>
    public static readonly List<DataTwoFact> FiveOriginal = new()
    {
        new DataTwoFact() { X1 = -1.05452, X2 = -709.6729, Y = 0 },
        new DataTwoFact() { X1 = -7.02454, X2 = -709.6721, Y = 19.6239 },
        new DataTwoFact() { X1 = -12.99435, X2 = -709.6715, Y = 39.2488 },
    ...
    /// <summary>
    /// 5 series (55 points), but only the same 3 real series as ThreeOriginal were measured —
    /// the other 2 were generated by fitting a 2nd-degree polynomial rather than measured.
    /// </summary>
    public static readonly List<DataTwoFact> ThreeOriginalAndTwoFake = new()
    {
        new DataTwoFact() { X1 = -1.05452, X2 = -709.6729, Y = 0 },
        new DataTwoFact() { X1 = -7.02454, X2 = -709.6721, Y = 19.6239 },
        new DataTwoFact() { X1 = -12.99435, X2 = -709.6715, Y = 39.2488 },
